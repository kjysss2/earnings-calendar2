...
CONFIRMED_TIMES = {
    ...
    # 8월 3일 (DART 기업설명회 공시 확인)
    ("2026-08-03", "S-Oil"): "10:00",
    ("2026-08-03", "현대제철"): "14:00",
    ("2026-08-03", "DL"): "14:00",

    # 8월 4일 (DART 기업설명회 공시 확인)
    ("2026-08-04", "에코프로"): "14:00",
    ("2026-08-04", "에코프로머티"): "14:00",
    ("2026-08-04", "에코프로에이치엔"): "14:00",
    ("2026-08-04", "한화"): "14:00",
    ("2026-08-04", "삼성증권"): "16:10",
    ("2026-08-04", "카카오페이"): "16:00",
    ("2026-08-04", "지누스"): "16:00",

    # 8월 5일 (DART 기업설명회 공시 확인)
    ("2026-08-05", "카카오게임즈"): "09:00",
    ("2026-08-05", "에이피알"): "10:00",
    ("2026-08-05", "카카오뱅크"): "10:00",
    ("2026-08-05", "LS에코에너지"): "14:00",
    ("2026-08-05", "현대백화점"): "16:00",
    ("2026-08-05", "SK텔레콤"): "16:00",

    # 8월 6일 (DART 기업설명회 공시 확인)
    ("2026-08-06", "카카오"): "09:00",
    ("2026-08-06", "롯데에너지머티리얼즈"): "10:00",
    ("2026-08-06", "CJ ENM"): "14:00",
    ("2026-08-06", "스튜디오드래곤"): "14:00",
    ("2026-08-06", "LG유플러스"): "14:00",
    ("2026-08-06", "CJ프레시웨이"): "15:00",
    ("2026-08-06", "엘앤에프"): "16:00",

    # 8월 7일 (DART 기업설명회 공시 확인)
    ("2026-08-07", "NAVER"): "09:00",
    ("2026-08-07", "롯데쇼핑"): "09:30",
    ("2026-08-07", "롯데케미칼"): "16:00",
    ("2026-08-07", "코오롱인더"): "16:00",

    # 8월 11일 (DART 기업설명회 공시 확인)
    ("2026-08-11", "NHN"): "09:00",
    ("2026-08-11", "CJ제일제당"): "09:30",
    ("2026-08-11", "CJ대한통운"): "10:00",
    ("2026-08-11", "한국타이어앤테크놀로지"): "15:30",
    ("2026-08-11", "NC"): "16:00",

    # 8월 12일 (DART 기업설명회 공시 확인)
    ("2026-08-12", "미래에셋증권"): "10:00",
    ("2026-08-12", "메리츠금융지주"): "16:00",

    # 8월 13일 (DART 기업설명회 공시 확인)
    ("2026-08-13", "달바글로벌"): "10:30",
    ("2026-08-13", "삼성생명"): "14:00",
    ("2026-08-13", "LG"): "15:30",

    # 8월 14일 (DART 기업설명회 공시 확인)
    ("2026-08-14", "현대해상"): "10:00",
}
